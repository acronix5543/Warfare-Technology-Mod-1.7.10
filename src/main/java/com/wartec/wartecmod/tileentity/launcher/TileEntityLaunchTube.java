...
public class TileEntityLaunchTube extends TileEntityLoadedBase implements ISidedInventory, IEnergyUser {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.LaunchTube";
	}
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			...
			PacketRegistry.wrapper.sendToAllAround(new TELaunchTubePacket(xCoord, yCoord, zCoord, slots[0]), new TargetPoint(worldObj.provider.dimensionId, xCoord, yCoord, zCoord, 250));
