	...
	public void onUpdate() {
		...
		if(activationTimer < 40) {
			...
			for(int i = 0; i < 5; i++) {
				...
				for(Entity e : list) {
					if(e instanceof EntityMissileBaseAdvanced || e instanceof EntityMissileCustom || e instanceof EntitySubsonicCruiseMissileBase || e instanceof EntitySupersonicCruiseMissileBase || e instanceof EntityHypersonicCruiseMissileBase) {
