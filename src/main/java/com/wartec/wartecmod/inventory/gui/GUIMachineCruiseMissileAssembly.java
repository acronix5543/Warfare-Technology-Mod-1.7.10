...
public class GUIMachineCruiseMissileAssembly extends GuiInfoContainer {

    private static ResourceLocation texture = new ResourceLocation(RefStrings.MODID + ":textures/gui/gui_cruise_missile_assembly.png");
    private TileEntityMachineMissileAssembly assembler;

    public GUIMachineCruiseMissileAssembly(InventoryPlayer invPlayer, TileEntityMachineMissileAssembly tedf) {
