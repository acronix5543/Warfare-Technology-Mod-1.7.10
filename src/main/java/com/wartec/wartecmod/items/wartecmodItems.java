...
public class wartecmodItems {
    ...
    public static Item itemNavigationGPS;
    public static Item itemNavigationINS;
    public static Item itemNavigationTERCOM;
    ...
    public static void initializeItem() {
        ...
        itemNavigationGPS = new Item().setCreativeTab(wartecmod.tabwartecmodparts).setMaxStackSize(64).setUnlocalizedName("ItemNavigationGPS").setTextureName("wartecmod:ItemNavigationGPS");
        itemNavigationINS = new Item().setCreativeTab(wartecmod.tabwartecmodparts).setMaxStackSize(64).setUnlocalizedName("ItemNavigationINS").setTextureName("wartecmod:ItemNavigationINS");
        itemNavigationTERCOM = new Item().setCreativeTab(wartecmod.tabwartecmodparts).setMaxStackSize(64).setUnlocalizedName("ItemNavigationTERCOM").setTextureName("wartecmod:ItemNavigationTERCOM");
    ...
    private static void registerItem() {
        ...
        GameRegistry.registerItem(itemNavigationGPS, (String)"ItemGuidanceSystemGPS");
        GameRegistry.registerItem(itemNavigationINS, (String)"ItemNavigationINS");
        GameRegistry.registerItem(itemNavigationTERCOM, (String)"ItemNavigationTERCOM");
